...
style: |
  ...
  section.lead { background: #d9e8cb; color: #19342b; }
  h1, h2, h3 { color: #173f35; font-family: 'Fraunces', serif; letter-spacing: 0; }
  h1 { font-size: 54px; }
  h2 { font-size: 38px; }
  h3 { font-size: 27px; }
  strong { color: #9d3f31; }
  table { font-size: 21px; border-collapse: collapse; }
  th { background: #315f4d; color: #ffffff; }
  th, td { padding: 10px 14px; }
  blockquote { border-left: 7px solid #c5783b; color: #315f4d; font-family: 'Fraunces', serif; font-size: 29px; padding-left: 22px; }
  footer { color: #53645d; font-size: 14px; }
